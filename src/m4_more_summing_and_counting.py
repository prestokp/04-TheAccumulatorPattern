...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 4
    answer = count_cosines_from(3, 6, -1)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(4, 7, 0.5)
    ...
    # Test 5:
    expected = 4
    answer = count_cosines_from(3, 8, -0.5)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 1
    answer = count_cosines_from(7, 9, 0.52)
...
def run_test_sum_unit_fractions_from():
    ...
    #Test 3:
    expected = 0.768771
    answer = sum_unit_fractions_from(10,20)
