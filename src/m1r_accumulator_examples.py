...
#
#            for k in range(r - 1):
#            for k in range(r):  CORRECT ANSWER
#            for k in range(r + 1):
#
...
#          what expression would you use in the _____ below?
#
#            for k in range((s+1)-r): If you were to do the range it would be r
#
...
#                  count = 0                        "count = 0" was put in the for loop
#                  if math.cos(r) > 0:                     if math.cos(k+r)>0:
#                      count = 1                            count = count + 1
#                  return count                       return count *don't want to put 'return count' in the loop
#
#     f. The code in the "graphics accumulation" example below includes:
#            for _ in range(n):
#        What does the   _   (underscore) mean? It's a place holder for a variable that hasnt been defined yet
#
...
#
#              x = starting_point.x                                     Correct Alternative Implementation
#              for k in range(n):
...
#                  circle = rg.Circle(point, radius)
#                  circle.attach_to(window)
#                  x = x + (2 * radius)                                 This changes the x variable twice
#
###############################################################################
